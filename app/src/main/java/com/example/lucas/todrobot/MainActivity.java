...
public class MainActivity extends Activity {
    ...
    public void modoMissao(View v){
        Intent intent = new Intent(this, ModoMissao.class);
        startActivity(intent);
    }
    public void estatisticas(View v){
        Intent intent = new Intent(this, Estatisticas.class);
        startActivity(intent);
    }
    public void socializar(View v){
        Intent intent = new Intent(this, Socializar.class);
        startActivity(intent);
    }
}
